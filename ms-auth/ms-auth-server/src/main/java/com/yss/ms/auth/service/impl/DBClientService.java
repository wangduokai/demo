package com.yss.ms.auth.service.impl;

import com.yss.ms.auth.bean.ClientInfo;
import com.yss.ms.auth.entity.Client;
import com.yss.ms.auth.mapper.ClientMapper;
import com.yss.ms.auth.service.ClientService;
import com.yss.ms.auth.util.client.ClientTokenUtil;
import com.yss.ms.common.exception.auth.ClientInvalidException;
import com.yss.ms.common.util.UUIDUtils;
